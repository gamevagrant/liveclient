 ...
 */
public class EyeViewAdapter extends BaseAdapter {
    ...
    public EyeViewAdapter(Context context, ArrayList<String> coll) {
        ctx = context;
        this.datas = coll;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int eyeSel = PreferencesUtils.getSharePreInt(ctx,"sel",-1);
        if(eyeSel ==position){
