...
public class DialogHelper {
    ...
    public static void Confirm(boolean isFource,Context ctx, CharSequence title, CharSequence message,
    ...
    public static void NotNegativeConfirm(Context ctx, CharSequence title, CharSequence message,
                                          CharSequence okText, OnClickListener oklistener) {
        Builder builder = createDialog(ctx, title, message);
        builder.setPositiveButton(okText, oklistener);
        builder.create().show();
    ...
    public static void Confirm(Context ctx, int titleId, int messageId,
                               ...
                               OnClickListener cancellistener) {
        Confirm(false,ctx, ctx.getText(titleId), ctx.getText(messageId), ctx.getText(okTextId), oklistener, ctx.getText(cancelTextId), cancellistener);
    }
